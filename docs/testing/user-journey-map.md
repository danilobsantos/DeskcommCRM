...
| J16.8 | Ocupação do Google no histórico não oferece ação inexistente | `agenda-ocupacao-do-google-no-historico.spec.ts`. Evidência: `evidence/agenda-historico-nao-oferece-acao.png` |
