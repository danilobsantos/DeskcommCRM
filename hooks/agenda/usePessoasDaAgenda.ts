 ...
 *
 * Quem foi revogado sai da lista: o filtro por pessoa é para quem atende
 * hoje. Quem está com o atendimento desabilitado (`is_available = false`) sai
 * por outra via — o servidor entrega `usuariosIndisponiveisIniciais` ao
 * `_client`, que filtra sem consulta nova.
 */
