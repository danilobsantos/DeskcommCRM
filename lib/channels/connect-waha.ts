...
const channelSchema = z.object({
  ...
  // SEM `.max(54)` aqui de propósito (merge main→dev 2026-09-14): nome legado de
  // 69 chars precisa CHEGAR ao bloco de cura abaixo (renomeia) ou à recusa com
  // código próprio. Validar tamanho no parse matava a cura antes dela nascer —
  // o teto é conferido em `nomeDaSessaoCabeNoWaha`, com motivo e reparo.
