...
// A Sidebar lê o tema resolvido para escolher o logo claro/escuro (dual-logo
// da dev). Sem o provider, `useTheme` lança — mesmo mock dos outros testes
// da barra (`sidebar-grupos`, `sidebar-nome-da-organizacao`).
vi.mock("@/lib/theme", () => ({
