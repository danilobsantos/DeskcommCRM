...
describe("catraca: ninguém mais repete o namespace", () => {
  const PERMITIDO = new Set([
    ...
    // Overlay do fork para VPS com proxy próprio (Dokploy/Coolify): repete os
    // defaults de imagem pelos mesmos motivos do compose de produção — YAML não
    // deriva de shell. Só existe no fork; o upstream não tem este arquivo.
