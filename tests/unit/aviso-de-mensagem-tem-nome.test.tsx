...
import { useInboundMessageAlerts, __resetContactCache } from "@/hooks/notifications/useInboundMessageAlerts";
...
beforeEach(() => {
  vi.clearAllMocks();
  // O hook cacheia o contato em memória: sem isto, o nome do primeiro caso
  // vazaria para os casos de 403/sem-nome.
  __resetContactCache();
  canal.onChange = null;
